...
<footer class="footer " style="background-color: #2C3D43FF;color: #FFFFFFFF;border-top: none;">
    <div class="container">
            ...
            <div class="is-grid grid-3">
                <div class="footer-item">
                    ...
                    <ul class="list-unstyled footer-list">
                        ...
                        <li>
                            <a href="/pages/faq.php" style="color: #FFFFFFFF;">
                ...
                <div class="footer-item">
                    ...
                    <ul class="list-unstyled footer-list">
                        <li>
                            <a href="/pages/terms-and-conditions.php" style="color: #FFFFFFFF;">
                                Conditions d&#039;utilisation
                            </a>
                        </li>
                        <li>
                            <a href="/pages/retour-echange.php" style="color: #FFFFFFFF;">
                                Retours &amp; échanges
                            </a>
                        </li>
                        <li>
                            <a href="/pages/confidentiality.php" style="color: #FFFFFFFF;">
